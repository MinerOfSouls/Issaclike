...
object_params = {
    ...
    "chest": {"speed": 0.3, "scale": 0.5, "looping": False, "collectable": False, "item_type": "chest",
              "body_type": PymunkPhysicsEngine.STATIC, "animated": False},
    "health_potion": {"speed": 0.3, "scale": 1, "looping": True, "collectable": True,
                      "item_type": "pick_health_potion"},
    "damage_potion": {"speed": 0.3, "scale": 1, "looping": True, "collectable": True,
                      "item_type": "pick_damage_potion"},
    ...
    "wisp": {"speed": 0.15, "scale": 1, "looping": True, "collectable": False, "item_type": "wisp",
             "moment_of_inertia": PymunkPhysicsEngine.MOMENT_INF},
    "static_fire": {"speed": 0.15, "scale": 0.5, "looping": True, "collectable": False, "item_type": "static_fire",
                    "moment_of_inertia": PymunkPhysicsEngine.MOMENT_INF, "body_type": PymunkPhysicsEngine.DYNAMIC},
    "projectile": {"speed": 0.05, "scale": 0.05, "looping": True, "collectable": False, "item_type": "projectile"},
    "magic_shield": {"speed": 0.3, "scale": 0.5, "looping": True, "collectable": False, "item_type": "magic_shield",
                     "moment_of_inertia": PymunkPhysicsEngine.MOMENT_INF, },
    "shoot_fire": {"speed": 0.3, "scale": 0.1, "looping": True, "collectable": False, "item_type": "shoot_fire",
                   "moment_of_inertia": PymunkPhysicsEngine.MOMENT_INF, "body_type": PymunkPhysicsEngine.DYNAMIC},
    "dash_effect": {"speed": 0.025, "scale": 1.5, "looping": False, "collectable": False, "item_type": "dash_effect",
                    "moment_of_inertia": PymunkPhysicsEngine.MOMENT_INF, "body_type": PymunkPhysicsEngine.KINEMATIC},
    "spawn_effect": {"speed": 0.025, "scale": 0.1, "looping": False, "collectable": False, "item_type": "spawn_effect",
                     "moment_of_inertia": PymunkPhysicsEngine.MOMENT_INF, "body_type": PymunkPhysicsEngine.KINEMATIC},
...
enemy_textures["goblin_move_west"] = enemy_sheets["goblin_move"].get_texture_grid((128, 128), 9, 9,
                                                                                  hit_box_algorithm=box)
...
def get_wizard_sprite():
    ...
    sprite.moving_animation_length = 7
    sprite.standing_animation_length = 7
    sprite.facing_calc = enemy_facing
    sprite.scale = 1
    return sprite
